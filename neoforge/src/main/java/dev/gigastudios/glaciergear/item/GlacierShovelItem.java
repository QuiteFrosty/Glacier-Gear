...
public class GlacierShovelItem extends ShovelItem {

    private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 660,
            9.0f, 0.0f, 28,
            TagKey.create(Registries.ITEM, ResourceLocation.parse("glacier_gear:glacier_shovel_repair_items")));

    public GlacierShovelItem(Item.Properties properties) {
