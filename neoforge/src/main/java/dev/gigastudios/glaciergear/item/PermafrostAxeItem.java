...
public class PermafrostAxeItem extends AxeItem {

    private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 900,
            10.0f, 0.0f, 32,
            TagKey.create(Registries.ITEM, ResourceLocation.parse("glacier_gear:permafrost_axe_repair_items")));

    private static final float FROZEN_TARGET_BONUS_DAMAGE = 4.0f;

    public PermafrostAxeItem(Item.Properties properties) {
        super(TOOL_MATERIAL, 20.0f, -2.0f, properties);
    }
